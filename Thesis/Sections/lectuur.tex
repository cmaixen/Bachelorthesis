...
%
%
Als we voor het voorbeeld \textit{(heel , goed)} bovenstaande gegevens in een kruistabel gieten krijgen we volgende 2x2 tabel:
%
%
\begin{table}[h]
\centering
...
\begin{center}
  ...
  \captionof{figure}{Bijdrage Bias en Variantie aan totale error (Gebaseerd op:\url{http://scott.fortmann-roe.com/docs/docs/BiasVariance/biasvariance.png})}
...
Eerder zeiden we al wanneer men spreekt of bias en variance, men eigelijk bezig is met over- en underfitting. Laten we eerst nog eens kijken wat juist overfitting is. 
