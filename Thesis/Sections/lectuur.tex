...
Als aanloop naar de experimentele analyse bekijken we met een eenvoudige proef de kracht van tf-idf. Onderstaande tabel geeft enkele Nederlandse recensies weer uit onze dataset met het woord of feature met de hoogste tf-idf voor die recensie na term weighting. De volledige recensies kan je lezen in bijlage \ref{bijlage term}.\\
